...
static const char *kernel_source =
    ...
    "                              __global int *dst) {\n"
    "  size_t gid = get_global_id(0) + get_global_id(1) * get_global_size(0);\n"
...
#define NUM_WORK_ITEMS (GLOBAL_SIZE_0 * GLOBAL_SIZE_1)
...
int main(const int argc, const char **argv) {
  ...
  /* Enqueue kernel */
  size_t global_work_size[2] = {GLOBAL_SIZE_0, GLOBAL_SIZE_1};
  size_t local_work_size[2] = {LOCAL_SIZE_0, LOCAL_SIZE_1};
  IS_CL_SUCCESS(clEnqueueNDRangeKernel(queue, kernel, /* work_dim */ 2,
